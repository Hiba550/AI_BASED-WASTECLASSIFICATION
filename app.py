...
GEMINI_API_KEY="AIzaSyDleawqB3eYF5W2shzeusAs0mjvL1FYmdk"
genai.configure(api_key=GEMINI_API_KEY) # or replace with your key directly, but less secure.
...
def process_image():
    ...
    Types of waste:Identify the specific waste materials present in the image. (next line)
    Degradability:Briefly state how long each type of waste takes to decompose. (next line)
    Disposal/Recycling:Suggest how to responsibly dispose of or recycle each waste type. (next line)
